...
SECONDARY approach (structural-feature ensemble, Kaggle 0.948). Kept as a
methodologically diverse final pick alongside main.py's PPR method (0.962).
Produces submission_ensemble_top460.csv.

Run:
    uv run python ensemble.py  (or: python ensemble.py with deps installed)
...
OUT_CSV = ROOT / "submission_ensemble_top460.csv"
