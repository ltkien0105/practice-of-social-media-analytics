...
# Probability-space blends
save("M11415803_Le_Trung_Kien_blend_prob_90_10.csv", 0.9 * p1 + 0.1 * p2)
save("M11415803_Le_Trung_Kien_blend_prob_80_20.csv", 0.8 * p1 + 0.2 * p2)

# Rank-space blends (handles calibration mismatch)
save("M11415803_Le_Trung_Kien_blend_rank_80_20.csv", 0.8 * r1 + 0.2 * r2)
save("M11415803_Le_Trung_Kien_blend_rank_70_30.csv", 0.7 * r1 + 0.3 * r2)
save("M11415803_Le_Trung_Kien_blend_rank_50_50.csv", 0.5 * r1 + 0.5 * r2)
